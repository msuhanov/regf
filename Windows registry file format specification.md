...
When a dirty hive is loaded by a boot loader (not by a kernel), the applicable transaction log file is used in the recovery. The first transaction log file is tried first.
